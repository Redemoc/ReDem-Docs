...
<Update label="2026-09-25">
  ## Behavior Tracking samples

  - Separate sample scripts for **typing** and **mouse movement**.
  - Mouse movements and clicks must share **one** capped array (last 300 events together). Separate buffers can leave leftover clicks that look like cold clicks.
  - See the [Behavior Tracking](/api-reference/others/behavior-tracking) guide.
</Update>
