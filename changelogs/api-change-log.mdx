...
<Update label="2025-12-02" description="v3.1.0">
  ...
  - <code style={{ color: "green" }}> POST /v3/retryRespondents </code> - Retry specific quality checks for a list of respondents within a survey.

  See the [endpoint docs](/api-reference/endpoints/v3/retryRespondents) for request/response details.
</Update>
