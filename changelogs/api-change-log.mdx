...
<Update label="2026-02-26" description="v3.1.3">
  ## CHS Limit Update

  - <code style={{ color: "green" }}> POST /v3/addRespondent </code> - The maximum number of CHS question/answer pairs stored on create has been reduced from `1000` to `300`.
