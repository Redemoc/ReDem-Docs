...
<Update label="2026-07-31" description="v3.1.8">
  ...
  - <code style={{ color: "green" }}> POST /v3/addRespondent </code> — OES answer translation is now generally available. Set `shouldTranslate: true` on an OES datapoint to translate non-valid, non-English answers to English during quality evaluation.
