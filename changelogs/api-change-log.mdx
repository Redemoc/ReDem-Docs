...
<Update label="2026-08-07" description="v3.1.9">
  ...
  - Coming soon on <code style={{ color: "green" }}> POST /v3/addRespondent </code> — Send a `DES` datapoint (v3 only) with optional `entranceTime`, optional `ip`, and up to 10 demographics (at least 4 for a valid score). At most one DES datapoint per respondent.
