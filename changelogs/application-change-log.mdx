...
<Update label="2026-06-18" description="v1.6.2">
  ## Teams
  ...
  ## Respondent Details
  - When opening the respondent details you can now see how much weight each quality check has on the respondent's overall ReDem Score.
