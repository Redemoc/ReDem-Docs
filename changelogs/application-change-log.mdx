...
<Update label="2026-08-27">
  ...
  When a quality check cannot produce a real 0–100 score, Respondent Details now shows a dash instead of `-999`, plus a short explanation of why the score is missing.
