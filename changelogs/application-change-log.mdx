...
<Update label="2025-12-02" description="v1.3.2">
  ...
  - **Recalculate specific checks**: You can now retry specific respondents and select exactly which quality checks to recalculate (OES, GQS, TS, CHS, BAS).
  ...
  - **Updated configuration**: Retry operations can include options to update allowed languages for OES, activate duplicate detection, and enable pattern checks for GQS during recalculation.
</Update>
