...
<Update label="2026-08-25" description="v1.7.1">
  ## Decipher Integration Agent
  - You can now add the **Duplicate Entrance Score (DES)** when generating Decipher XML.
  - DES is not suggested automatically. Click **Add Duplicate Entrance Score (DES)**, then map demographic types to survey questions. Entrance time is captured in the survey; IP is not collected.
  - See the [Decipher Integration Assistant](/integration-guides/decipher) and [Duplicate Entrance Score guide](/knowledge-base/quality-checks/duplicate-entrance-score).
</Update>
