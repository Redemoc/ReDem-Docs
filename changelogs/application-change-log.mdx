...
<Update label="2026-08-13" description="v1.6.9">
  ## File Import
  - Quality-check suggestions in Quick Import are now more accurate, and the analysis step finishes faster.

  ## Duplicate Entrance Score
  - You can now configure the **Duplicate Entrance Score (DES)** in Quick Import. Map demographic columns — and an IP column, if you have one — in the same way as other quality checks.
