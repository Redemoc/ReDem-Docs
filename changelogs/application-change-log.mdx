...
<Update label="2026-08-27" description="v1.7.1">
  ## File Import
  - Quick Import is much faster for [supported survey platforms](/features/file-import#supported-survey-tools), and quality-check suggestions are more accurate.
  ...
  - See the [Duplicate Entrance Score guide](/knowledge-base/quality-checks/duplicate-entrance-score) and [File Import](/features/file-import) for details.
