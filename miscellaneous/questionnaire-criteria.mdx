...
We’ve built a [ChatGPT OES Question Master](https://chatgpt.com/g/g-3YkEFGt1h-redem-oes-question-master) that generates open-ended survey questions based on a given topic, which can be used for ReDem's Open Ended Score (OES) quality check.
