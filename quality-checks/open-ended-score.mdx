...
Our system automatically detects responses copied and pasted into survey text fields. These are classified as "**Copy & Paste"** answers and are assigned a score of of 0.

<Note> This feature is available only with ReDem's integration into your survey tool or through our API.</Note>
