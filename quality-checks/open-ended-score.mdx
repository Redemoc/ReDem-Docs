...
We analyze response structures to ensure they follow a plausible pattern, helping to detect thematically relevant but externally sourced answers, such as those from Wikipedia. Responses identified as "**Fake Answers**" are assigned a score of 0.
