---
title: "Behavior Analysis Score"
description: "Learn how the Behavior Analysis Score evaluates various typing behaviors"
icon: "keyboard"
iconType: "regular"
---
...
## What is the Behavior Analysis Score?
The **Behavior Analysis Score (BAS)** is a quality score designed to evaluate user typing patterns. It analyzes various aspects of typing behavior to distinguish between natural human typing and potentially automated or artificial inputs.
...
Combines manual input with auto-complete suggestions, resulting in distinct patterns of rapid text insertion. It is still considered natural if it falls within acceptable
...
### Scoring system
The **Behavioral Analysis Score (BAS)** uses a structured scoring system to evaluate the quality of typing behavior. The scoring system is defined as follows:  
