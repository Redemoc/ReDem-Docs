...
<Update label="2025-03-05" description="Unversioned changes">
  ...
  - Enhanced the **request body cleaning settings** by allowing **activate/deactivate** options for each quality check and enhanced **cleaning settings** by introducing **Behavior Analysis Score (BAS)** along with its categories.
  - Renamed the **Fake Answer** category in **Open-Ended Score (OES)** to **AI-Generated Answer**.
  - We have **enhanced** the response structure by adding a field to retrieve **Behavior Analysis Score (BAS)** results.
  ...
  - Removed the **Copy-Paste** category from **Open-Ended Score (OES)** and incorporated it under **Behavior Analysis Score (BAS)**.
