...
<Update label="2025-03-11" description="Unversioned changes">
  ...
  The <code style={{ color: "green" }}> POST /respondent/add </code> endpoint has been updated to rename parameters in the cleaning settings, changing from **camelCase to UPPERCASE_UNDERSCORE** formatting.
