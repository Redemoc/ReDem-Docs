...
In the [API reference](/api-reference/introduction), each operation’s request body schema includes an **Authentication** note stating whether a **private** or **public** key is allowed.
...
- Rotate keys regularly to maintain security. We recommend every 90 days.
