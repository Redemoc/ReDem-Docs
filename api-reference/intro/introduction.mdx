...
ReDem's API uses versioned endpoints to ensure backward compatibility while introducing new features:

- **v1**: Sunset. `/v1` endpoints are no longer supported and return **404**.
