...
<Steps titleSize="h3">
  ...
  <Step title="Prepare your request data">
    ...
    <p>In an asynchronous response approach, it is recommended to keep the `synchronousResponse` field set to `false`. This allows you to continue engaging with your respondents without waiting for a response from ReDem..</p>
