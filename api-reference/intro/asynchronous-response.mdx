...
<Steps titleSize="h3">
  ...
  <Step title="Synchronize respondent evaluations">
    ...
    <p>To do this, you can use the [Get Respondent](/api-reference/endpoints/v3/getRespondent) endpoint or the [Get All Respondents](/api-reference/endpoints/v3/getAllRespondents) endpoint.</p>
  </Step>
</Steps>