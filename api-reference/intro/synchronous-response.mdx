...
<Steps titleSize="h3">
  ...
  <Step title="Prepare your request data">
    ...
    <p>In a synchronous response approach, it is recommended to keep the `synchronousResponse` field set to `true`. It allows you to get a response from ReDem in real time.</p>
