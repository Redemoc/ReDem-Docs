...
<Steps titleSize="h3">
  ...
  <Step title="Go and connect with ReDem 🚀">
    <p>Great! Now that you have your API key, you can use it as a bearer token to securely send or retrieve data from ReDem in any API request.</p>
    ```plainApiKey_xxx
        Authorization: Bearer your_api_key_xxx
    ```
  </Step>
</Steps>
