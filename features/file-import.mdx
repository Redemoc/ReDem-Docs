...
<Steps titleSize="h3">
  ...
  <Step title="Select Quality Checks and Questions">
    ...
    - **Configure Other Quality Checks:**
      ...
      - **Duplicate Entrance Score:** Map demographic columns to DES types (at least 4, up to 10). Optionally map an IP column. Column names are searchable. See the [Duplicate Entrance Score guide](/knowledge-base/quality-checks/duplicate-entrance-score) and [best-practice set-up](/knowledge-base/best-practices/best-practice-setup#duplicate-entrance-score).
  </Step>
...
<Steps titleSize="h3">
  ...
  <Step title="Review AI-Recommended Quality Checks">
    ...
    **Duplicate Entrance Score (DES)**
    - DES is **not** suggested automatically. Add it yourself if you want it on this survey.
    - Map demographic columns to DES types (at least 4, up to 10) and optionally map an IP column. See the [Duplicate Entrance Score guide](/knowledge-base/quality-checks/duplicate-entrance-score).
  </Step>
  <Step title="Determine Cleaning Settings">
    Decide whether to enable ReDem’s Automatic Data Cleaning. This feature applies exclusion recommendations based on predefined thresholds.
    - **If Enabled:** You can further customize the cleaning settings to suit your project.
