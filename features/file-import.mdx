...
<Steps titleSize="h3">
  <Step title="Open Change Quality Checks">
    On your survey **results** page, click **Change Quality Checks** at the top (next to **Cleaning Settings**).
...
If ReDem cannot update a respondent after several automatic retries, that row is highlighted **yellow** in the respondent table. Those interviews still reflect the **previous** quality check settings and scores. Contact [support@redem.io](mailto:support@redem.ai) if you need help with failed rows. You can still run **Change Quality Checks** again for other setting changes, but failed rows are not repaired by applying new settings alone.
