...
If ReDem cannot update a respondent after several automatic retries, that row is highlighted **yellow** in the respondent table. Those interviews still reflect the **previous** quality check settings and scores. Contact [support@redem.io](mailto:support@redem.io) if you need help with failed rows.
