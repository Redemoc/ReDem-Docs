...
Export your survey from Decipher as Excel, then upload that file to Quick Import.
...
Export your survey data from AYTM and upload the Excel file directly to Quick Import. ReDem detects the AYTM format and prepares the file for the import steps that follow.

### Confirmit

Export your survey from Confirmit and upload the Excel file directly to Quick Import. ReDem detects the Confirmit format, maps the data and datamap sheets, and continues with the normal import flow.

### Quantilope

Export your survey from Quantilope and upload the Excel file directly to Quick Import. ReDem detects the Quantilope format and prepares the codebook and data sheets automatically.
