...
<Steps titleSize="h3">
  ...
  <Step title="Review AI-Recommended Quality Checks">
    ...
    **Duplicate Entrance Score (DES)**
    - The AI assistant does not currently recommend DES. If you would like to include it, add the check when you review quality checks.
    - Map demographic columns to DES types (at least 4, up to 10). You can also map an IP column if one is available. See the [Duplicate Entrance Score guide](/knowledge-base/quality-checks/duplicate-entrance-score).
  </Step>
  <Step title="Determine Cleaning Settings">
    Decide whether to enable ReDem’s Automatic Data Cleaning. This feature applies exclusion recommendations based on predefined thresholds.
    - **If Enabled:** You can further customize the cleaning settings to suit your project.
