...
<Steps titleSize="h3">
  ...
  <Step title="Select Quality Checks and Questions">
    ...
    - **Configure Other Quality Checks:**
      ...
      - **Coherence Score:** Select all questions you want evaluated for coherence. In **Survey Description & Exclusion Rules**, add survey context and any custom exclusion rules.
