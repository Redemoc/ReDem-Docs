...
<Steps titleSize="h3">
  ...
  <Step title="Select Quality Checks and Questions">
    ...
    - **Configure Other Quality Checks:**
      ...
      - **Duplicate Entrance Score:** Map demographic columns to DES types (at least 4, up to 10). You can also map an IP column if one is available. Column names are searchable. See the [Duplicate Entrance Score guide](/knowledge-base/quality-checks/duplicate-entrance-score) and [best-practice set-up](/knowledge-base/best-practices/best-practice-setup#duplicate-entrance-score).
  </Step>
...
<Steps titleSize="h3">
  ...
  <Step title="Review AI-Recommended Quality Checks">
    ...
    **Duplicate Entrance Score (DES)**
    ...
    - Review the suggested demographics, adjust as needed (at least 4, up to 10), and map an IP column if one is available. See the [Duplicate Entrance Score guide](/knowledge-base/quality-checks/duplicate-entrance-score).
  </Step>
  <Step title="Determine Cleaning Settings">
    Decide whether to enable ReDem’s Automatic Data Cleaning. This feature applies exclusion recommendations based on predefined thresholds.
    - **If Enabled:** You can further customize the cleaning settings to suit your project.
