...
- **Grid-Question Score (GQS)**: <br/> Define a threshold for the Grid-Question Score and set a minimum number of items to filter out low-quality responses.

- **Coherence Score (CHS)**: <br/> Set a threshold for the Coherence Score to filter out low-quality responses.
