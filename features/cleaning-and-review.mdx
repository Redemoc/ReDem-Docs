...
On the survey **results** page, the **ReDem Score** card shows how many respondents are excluded. When at least one respondent is excluded, an **info icon** appears next to **Excluded Respondents**. Click it to open a breakdown of why respondents were excluded.
...
<Steps titleSize="h3">
  <Step title="Open the survey results page">
