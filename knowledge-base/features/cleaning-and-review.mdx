...
Per-respondent exclusion reasons are still available in the respondent table (**Reasons for Exclusion** column) and in each respondent's **Cleaning** tab. See [Respondent Insights](/features/respondent-insights) for details.
