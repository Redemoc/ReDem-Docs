...
<CardGroup cols={2}>
  <Card title="Quick Import" icon="file-import" href="/features/quick-import">
    Easily bring your survey data into ReDem by uploading it through the ReDem Application!
  </Card>
