...
In Quick Import this is the **Survey Description & Exclusion Rules** field. You can also put custom exclusion rules in that text, for example: remove respondents who select a brand that does not exist.

### When Survey Description is Especially Useful

The survey description is particularly valuable when your survey asks about **current events after the model's training cutoff of May 18, 2026**. Examples include:
