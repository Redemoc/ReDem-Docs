...
The survey description is particularly valuable when your survey asks about **current events that occurred after the training cutoff date of the large language models**, or when you want to apply custom exclusion rules. Examples include:
...
- **Custom exclusion rules**: Specific rules to exclude respondents (e.g., choosing a non-existing brand in the survey, or selecting a specific answer)
