...
You can add it during data import, or via the API as `surveyDescription` on the CHS data point. If your organization requires it, the field is mandatory on import. When provided, it must be between 20 and 500 characters.
...
<Info>
**AI knowledge cutoff:** The AI model has a knowledge cutoff of **late September 2024**. It may not recognize products, brands, venues, or events released after this date. If the survey covers anything newer, include it in the survey description so the Coherence Score does not treat unfamiliar names as implausible.
</Info>
...
- **Recent context the model may not know**: newly opened facilities, product launches, political events, or market changes after late September 2024
...
> This survey evaluates shopping experiences at the Grand Central Mall, a new shopping center that opened in downtown Springfield in November 2025. The mall features over 150 stores including major retailers, restaurants, a cinema complex, and an entertainment area. The survey aims to understand visitor experiences, shopping patterns, and satisfaction with the new facility.

### Example: Exclusion rule

> Exclude respondents who select a brand that does not exist in this market. The survey was conducted in March 2026 and covers awareness of brands launched after 2024.
