...
- If your sample contains mixed modes (e.g., mobile vs desktop) or different interview types, grouping (so-called “scoring groups”) may be used so comparisons are made within a consistent subgroup.
