...
When you select DES, ReDem recommends which demographic questions to use. Review and adjust the suggestions as needed. Your mapping is kept when you change quality checks, add respondents, or reuse a previous survey’s setup. See [File Import](/features/file-import).
