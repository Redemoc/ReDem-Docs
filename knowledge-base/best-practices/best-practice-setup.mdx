...
To ensure the Duplicate Entrance Score functions reliably, please follow the recommendations below. In the Quick Import, map these demographics to survey columns when you configure the check. The AI assistant does not currently recommend DES.
