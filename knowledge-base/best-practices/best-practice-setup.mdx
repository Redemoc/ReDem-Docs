...
To ensure the Duplicate Entrance Score functions reliably, please follow the recommendations below. In Quick Import, map these demographics to survey columns yourself — the AI assistant does not suggest DES automatically.
